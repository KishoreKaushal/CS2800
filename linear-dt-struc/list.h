...
void push_front(list*, void*);                 /* Adds data to the linked lists's front */
void push_back(list*, void*);                 /* Adds data to the linked lst's back */
...
int get_front_int(list*);
int get_back_int(list*);
void push_front_int(list*, int );
void push_back_int(list*, int);
